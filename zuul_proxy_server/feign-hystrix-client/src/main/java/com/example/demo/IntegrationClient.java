...
public class IntegrationClient {
	...
	@Autowired
	private OffersServiceClient offServiceClient;
	
	@Autowired
	private RecommendationServiceClient reServiceClient;
	...
	public Collection<Product> getRecommendations(){
		return this.reServiceClient.getRecommendations();
	}
	...
	public Collection<Offers> getOffers() {
		return this.offServiceClient.getCurrentOffers();
	}
